...
const ExperienceCard = ({logo,companyName,jobTitle,jobType,location, period, isPresent=false }:Experience) => {
  return (
    <div className=' mt-2 px-6 py-4 border-[0.5px] bg-secondary/5 hover:bg-secondary/15 transition-all duration-300 border-secondary/60 rounded-xl w-full border-dashed backdrop-blur-3xl relative z-10 flex flex-col gap-6'>
